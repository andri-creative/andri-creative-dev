...
import { useScreenshot } from "@/app/hooks/useScreenshot"
...
interface ProjectDetailProms {
    project: ProjectStats
}

export default function ProjectDetailComponent({ project }: ProjectDetailProms) {
    const { accentColor } = useThemeMode();
    const { screenshot } = useScreenshot(project.demoUrl);
                                        ...
                                        <Flex direction="column" gap="3">
                                            ...
                                            <Flex justify="between">
                                                ...
                                                <Text size="2" weight="medium">
                                                    {project.tools.length > 1 ? "Full Stack" : "Frontend"}
                                                </Text>
                                            </Flex>
                                        </Flex>
                                    </Card>
