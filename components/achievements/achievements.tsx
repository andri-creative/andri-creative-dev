    ...
    return (
        <>
            <Box p={{ initial: 'var(--space-1)', sm: 'var(--space-3)', md: 'var(--space-6)' }}>
                ...
                <Grid columns={{ initial: '1', sm: '2', md: '3', xl: '4' }} gap="var(--space-4)">
                        ...
                        <Box maxWidth="440px" key={i.id} >
                            <Card size="2" style={{ position: "relative" }}>
                                ...
                                <Flex direction="column" gap="3" mt="2">
                                    ...
                                    <Text as="p" size="2" weight="medium" color="blue" style={{
                                        lineHeight: '1.3',
                                        display: '-webkit-box',
                                        WebkitLineClamp: 1,
                                        WebkitBoxOrient: 'vertical',
                                        ...
                                        {i.issuer.length > 60 ? i.issuer.substring(0, 60) + '...' : i.issuer}
                                    </Text>
